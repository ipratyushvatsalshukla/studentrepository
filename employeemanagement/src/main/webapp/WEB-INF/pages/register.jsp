...
<form:form class="form-group" method="get" action="save" modelAttribute="employee">
			<div class="form-group row">
				<label for="Name" class="btn btn-primary col-sm-12 col-lg-6 col-form-label">Enter the Employee Name:</label>
                <form:input type="text" class="form-control col-sm-12 col-lg-6" path="sname"/>
			</div>
			<div class="form-group row">
				<label for="pwd" class="btn btn-primary col-sm-12 col-lg-6">Enter the Password:</label>
		
                 <form:input type="password" class="form-control col-sm-12 col-lg-6" path="password"/>
			</div>
			<div class="form-group row">
				<label for="Name" class="btn btn-primary col-sm-12 col-lg-6 col-form-label">Enter Department:</label>
