...
<body class="bg-light">
	...
	<br>
	<h1 class="text-center text-primary">Welcome to the Dashboard ${name} !</h1>
	<br>
	<br>
	<a href="./allcustomers?name=${name}" class="btn btn-primary btn-lg ml-2" role="button">Get All customer details</a>
	<br>
	<br>
	...
	<table class="table table-striped">
		...
		<c:forEach items="${list}" var="cust">
			<tr>
				...
				<td><a href="./modifycustomer?id=${cust.id}" class="btn btn-info" role="button">Modify</a></td>
			</tr>
		</c:forEach>
