...
<body class="bg-light">
	<div class="container">
		...
		<form:form method="get" action="save" modelAttribute="customer"
			class="mr-5">
			<br>
			<br>
			...
			<fieldset class="form-group">
				<div class="row">
					<legend class="col-form-label col-sm-2 offset-sm-3 pt-0">Account
						Type</legend>
					<div class="col-sm-5">
						...
						<div class="form-check">
							<form:radiobutton path="accType" value="Customer"
								label="Customer" class="form-check-input" />
						</div>
					</div>
				</div>
			</fieldset>
